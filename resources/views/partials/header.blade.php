          ...
          <div class="col-md-6">
            <div class="lc-block mb-3 mb-md-0">
              <div class="ratio ratio-16x9" lc-helper="video-embed">
                ...
                <iframe class="video-js vjs-theme-sea"  style="border-radius: 10px;"  src="{{ $home->vedio_link }}"  title="Iframe Example"></iframe>
          ...
          <div class="col-md-6 align-self-center" dir="rtl">
            <div class="lc-block mb-2">
              <div editable="rich">
                ...
                <p class="text-secondary" style="word-break: break-all;width : 60%;">
              {{ $home->description }}
                  <br>
                </p>
              </div>
